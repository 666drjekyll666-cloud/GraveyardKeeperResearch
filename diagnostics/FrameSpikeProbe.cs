    ...
    public sealed class FrameSpikeProbePlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo(
                ...
                "Normal-frame work is limited to Stopwatch timestamp + GC.CollectionCount(0..2). " +
                "No object scans, stack traces, or per-frame log writes are performed. " +
        ...
        {
            // A focus transition can itself create an irrelevant long frame. Restart the
            // interval baseline so the next Update is not misclassified as gameplay work.
            ResetSample();
        }
